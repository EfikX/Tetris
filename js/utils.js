...
const onUP = new Audio('audio/up.mp3');
const onRight = new Audio('audio/up.mp3');
const onLeft = new Audio('audio/up.mp3');
const Down = new Audio('audio/up.mp3');
